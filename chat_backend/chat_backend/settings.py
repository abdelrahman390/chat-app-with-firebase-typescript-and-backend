...
SECRET_KEY = 'django-insecure-oc1x522rb4j_5l5f29-fe5^!--74efgzkp1nd7i6%(@)yn3v4#'
...
firebaseConfig = {
  ...
  'databaseURL': "https://chat-app-7742a-default-rtdb.firebaseio.com",
  'projectId': "chat-app-7742a",
  'storageBucket': "chat-app-7742a.firebasestorage.app",
